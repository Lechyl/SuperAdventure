...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
        ...
        public SuperAdventure()
        {
            ...
            _player.Inventory.Add(new InventoryItem(World.ItemByID(World.ITEM_ID_CURSED_SWORD), 1));
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            if (newLocation.MonsterLivingHere != null)
            {
                ...
                _currentMonster = new Monster(standardMonster.CurrentHitPoints, standardMonster.MaximumHitPoints,
                    standardMonster.ID, standardMonster.Name, standardMonster.MaximumDamage, standardMonster.RewardExperiencePoints, standardMonster.RewardGold);
